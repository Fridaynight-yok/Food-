...
import 'package:flutter_application_3/app/food/add_food.dart';
import 'package:flutter_application_3/app/food/detail.dart';
import 'package:flutter_application_3/app/food/foodjson.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //collection foods
  final foods = FirebaseFirestore.instance.collection('foodMenu');
  ...
  void getFoodsByName(String name) {
    thaiFoods =
        (foodJson['thai_foods'] as List).where((foodData) {
                    ...
                    builder: (context, asyncSnapshot) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String chefName = chef['name'] ?? "ค่านี้ null";
                          String imageUrl =
                              thaiFood['image_url'] ?? "ค่านี้ null";
                          String menuName =
                              thaiFood['menu_name'] ?? "ค่านี้ null";
                          String ingredients =
                              thaiFood['ingredients'] ?? "ค่านี้ null";
                          return InkWell(
                            onTap: () {
                              Navigator.push<void>(
                                context,
